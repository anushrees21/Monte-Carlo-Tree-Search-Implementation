...
class MCTS:
    ...
    #-----------------------------------------------------------------------#
    # Description:
    #   Prints the simulation result to file.
    ...
    def Run(self, MaxIter=5000):
        ...
        # Print the best action found.
        BestNode = self.SelectChild(self.root)
        BestAction = game.GetAction(self.root.state, BestNode.state)
